...
from app.services.agent.phase4 import models  # lightweight value types
...
def get_phase4():
    ...
    from app.services.agent.phase4.coordinator import get_phase4 as _g
    return _g()


def get_event_bus():
    """Return the process-wide event bus (lazy import)."""
    from app.services.agent.phase4.event_bus import get_event_bus as _g
    return _g()
