...
class Phase4Coordinator:
    ...
    def start(self) -> None:
        ...
        if self.started:
            return
        try:
            from app.services.agent.phase4.skill_store import SkillStore
            from app.services.agent.phase4.skill_maker import SkillMaker
            from app.services.agent.phase4.checker import Checker
            from app.services.agent.phase4.learner import Learner
            ...
            if _VISION_ENABLED:
                try:
                    from app.services.agent.phase4.vision_verifier import VisionVerifier
